					...
					<div class="w-100"></div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nama" value="<?=$this->fungsi->user_login()->nama?>">
							</div>
						</div>
					<div class="w-100"></div>
						<div class="col-md-12">
					...
					<div class="w-100"></div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea name="alamat" class="form-control"><?=$this->fungsi->user_login()->alamat?></textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
